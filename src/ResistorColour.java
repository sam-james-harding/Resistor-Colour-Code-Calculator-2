...
public enum ResistorColour {
    ...
    GREEN   (0,   255, 0,   5,    100000.0,   0.5,  null),
    BLUE    (0,   0,   255, 6,    1000000.0,  0.25, null),
    PINK    (255, 20,  147, 7,    10000000.0, 0.1,  null),
    GREY    (105, 105, 105, 8,    null,       0.05, null),
